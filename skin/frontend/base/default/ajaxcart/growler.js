...
Growler = (function(){
	...
	return Class.create({
		initialize: function(options){
			...
			this.loader = new Element("div", { "class": "ajaxloder", "id": "ajaxloder" });
			this.loader.setStyle({ position: ((IE==6)?"absolute":"fixed"), padding: "10px", "width": opt.width  });
			...
			this.loader.wrap( document.body );		
		}
		...
		,info: function(msg, options){
			return specialNotice(this.growler, msg, options, "", "#000", "#fce702");
		}
