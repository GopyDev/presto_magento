...
Payment.prototype = {
    ...
    nextStep: function(transport){
        ...
        */
        ...
        checkout.setStepResponse(response);
		document.getElementById('opc-payment').removeClassName('active');
...
Review.prototype = {
    ...
    save: function(){
		//  window.location.href = "https://www.prestofreshgrocery.com/checkout/onepage/success";
		
		
		
		document.getElementById('checkout-review-table').style.display = 'none'; 
		document.getElementById('checkout-progress-wrapper').style.display = 'none';
            ...
            if (response.success) {
               this.isSuccess = true;
                ...
                if (msg) {
                    alert(msg);
					/***********************************
						Customize for OnePage checkout,
							If payment is failure
							Dated: 12/2/2016
					/***********************************/
					// location.reload();
					document.getElementById('checkout-review-submit').style.display = 'none';
					document.getElementById('opc-payment').addClassName('active');
					document.getElementById('opc-review').removeClassName('active');
