...
Checkout.prototype = {
    initialize: function(accordion, urls){
        ...
        this.steps = ['login', 'freegift', 'billing', 'shipping', 'shipping_method', 'payment', 'review'];

        this.accordion.sections.each(function(section) {
            Event.observe($(section).down('.step-title'), 'click', this._onSectionClick.bindAsEventListener(this));
        }.bind(this));
 		this.accordion.openSection('opc-login');
		
		this.accordion.openSection('opc-freegift');
...
//
		...
		checkout.setFreegift();
    },

    noThanks: function(transport){
		checkout.setFreegift();
    }
