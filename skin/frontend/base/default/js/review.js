...
OrderReviewController.prototype = {
    ...
    _pleaseWait : true,
    shippingSelect : true,
    reloadByShippingSelect : true,
    _copyElement : true,
    onSubmitShippingSuccess : true,
    shippingMethodsUpdateUrl : true,
    _updateShippingMethods: true,
    _ubpdateOrderButton : true,
    shippingMethodsContainer: true,
    _submitUpdateOrderUrl : true,
    _itemsGrid : true,
