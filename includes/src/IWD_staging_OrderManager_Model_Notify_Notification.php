...
class IWD_OrderManager_Model_Notify_Notification extends Mage_Core_Model_Abstract
{
    ...
    {
        $cancel_link = Mage::getUrl('iwd_order_manager/confirm/edit', array('action'=>'cancel', 'pid'=>$log->getConfirmLink()));
        $confirm_link = Mage::getUrl('iwd_order_manager/confirm/edit', array('action'=>'confirm', 'pid'=>$log->getConfirmLink()));
    ...
    protected function paymentBlockHtml($order)
    {
        ...
        try {
            ...
            Mage::log($exception, null, 'iwd_order_manager.log');
