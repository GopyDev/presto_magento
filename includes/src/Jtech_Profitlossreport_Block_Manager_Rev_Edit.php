...
class Jtech_Profitlossreport_Block_Manager_Rev_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
	public function __construct()
	{
		...
		$this->_controller = 'manager_rev';
		
		$this->_updateButton('save', 'label', Mage::helper('profitlossreport')->__('Save Revenue Item'));
		$this->_updateButton('delete', 'label', Mage::helper('profitlossreport')->__('Delete Revenue Item'));
	...
	public function getHeaderText()
	{
		...
		{
			return Mage::helper('profitlossreport')->__('Edit Revenue Item');
		} else {
			return Mage::helper('profitlossreport')->__('Create Revenue Item');
		}
	}
    ...
    {
        return $this->getUrl('*/*/deleterevenue', array($this->_objectId => $this->getRequest()->getParam($this->_objectId)));
    }
}