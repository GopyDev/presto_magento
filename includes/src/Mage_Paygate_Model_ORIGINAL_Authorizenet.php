...
class Mage_Paygate_Model_Authorizenet extends Mage_Payment_Model_Method_Cc
{
    ...
    {
        Mage::log($amount,null,'amount_Authorizenet.log');
		Mage::log($payment,null,'amount_Authorizenet2.log');
		if ($amount <= 0) {
    ...
    {
		if($text == 'A duplicate transaction has been submitted.') {
			$text = 'For security purposes, please wait at least 2 minutes from your original payment attempt before trying again. We apologize for any inconvenience!';
