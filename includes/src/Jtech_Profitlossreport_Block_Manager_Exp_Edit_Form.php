...
class Jtech_Profitlossreport_Block_Manager_Exp_Edit_Form extends Mage_Adminhtml_Block_Widget_Form
{
	protected function _prepareForm()
	{
		$form = new Varien_Data_Form(array(
			'id'		=> 'edit_form',
			'action'	=> $this->getUrl('*/*/saveexpense', array('id' => $this->getRequest()->getParam('id'))),
			'method'	=> 'post'
		));
		
		$fieldset = $form->addFieldset('attributes_form_', array('legend' => Mage::helper('profitlossreport')->__('Expense Item Details')));
