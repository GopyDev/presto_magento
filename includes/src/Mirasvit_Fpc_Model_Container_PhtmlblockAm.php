...
class Mirasvit_Fpc_Model_Container_PhtmlblockAm extends Mirasvit_Fpc_Model_Container_Abstract
{
    ...
    protected function _renderBlock()
    {
        ...
        if ($block = Mage::app()->getLayout()->createBlock($this->_definition['block'])) {
            $html = $block->setId($this->_definition['set_id'])->setTemplate($this->_definition['template'])->toHtml();
        }
