...
ADD FOREIGN KEY (`slide_id`) REFERENCES `{$this->getTable('interaktingslider_slide')}` (`slide_id`) ON DELETE CASCADE ON UPDATE CASCADE,
ADD FOREIGN KEY (`store_id`) REFERENCES `{$this->getTable('core_store')}` (`store_id`) ON DELETE CASCADE ON UPDATE CASCADE;
INSERT INTO `{$this->getTable('interaktingslider_slide')}` (`slide_id`, `name`, `content`, `from_time`, `to_time`, `is_active`) VALUES(1, 'Diapo 1', '<p style=\"text-align: center; width: 100%;\"><img align=\"middle\"  src=\"media/upload/image/iphone.png\" /></p>', '2009-11-06 04:46:36', NULL, 1),(2, 'Diapo 2', '<p style=\"text-align: center; width: 100%;\"><img src=\"media/upload/image/i_pod.png\" alt=\"\" /></p>', '2009-11-06 06:46:36', NULL, 1),(3, 'Diapo 3', '<p style=\"text-align: center;\"><img src=\"media/upload/image/ipod_touch.png\" alt=\"\" /></p>', '2009-11-06 10:46:36', NULL, 1),
(4, 'Diapo 4', '<p style=\"text-align: center; \"><img src=\"media/upload/image/ipad_mini.png\" alt=\"\" /></p>', '2009-11-06 10:46:36', NULL, 1);
