...
class Mage_Sales_Model_Quote_Address_Rate extends Mage_Shipping_Model_Rate_Abstract
{
    ...
    public function importShippingRate(Mage_Shipping_Model_Rate_Result_Abstract $rate)
    {
		...
		$cid = Mage::getSingleton('checkout/type_onepage')->getQuote()->getShippingAddress()->getCountryId();
		
		$cocheck = Mage::getSingleton('customer/session')->isLoggedIn();
