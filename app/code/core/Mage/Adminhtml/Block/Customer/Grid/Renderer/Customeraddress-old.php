<?php
class Mage_Adminhtml_Block_Customer_Grid_Renderer_Customeraddress extends Mage_Adminhtml_Block_Widget_Grid_Column_Renderer_Abstract
{
	...
	public function render(Varien_Object $row)
	{
		...
		$address = $addressdata['street'] ."  ". $addressdata['city'] .",  ".$addressdata['region'] .", ".$addressdata['postcode'];
