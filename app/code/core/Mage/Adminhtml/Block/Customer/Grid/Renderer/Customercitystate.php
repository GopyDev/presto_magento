<?php
class Mage_Adminhtml_Block_Customer_Grid_Renderer_Customercitystate extends Mage_Adminhtml_Block_Widget_Grid_Column_Renderer_Abstract
{
	...
	public function render(Varien_Object $row)
	{
		...
		$address =  $addressdata['city'] .",  ".$addressdata['region'];
