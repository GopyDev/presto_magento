...
echo 'Option: '. $option->getTitle() . ' [id: ' . $option_id . ']';
...
$bundleproductdata = 'Selection Name: ' . $selection_name;
$bundleproductdata .= ', SKU: ' . $selection_sku;
$bundleproductdata .= ', Qty: ' . $selection_qty;
$bundleproductdata .= ', ID: ' . $selection_id;
$bundleproductdata .= ', Product ID: ' . $selection_product_id;
$bundleproductdata .= ', Weight: ' . $selection_weight;
$bundleproductdata .= ', Price: ' . $selection_price;

echo $bundleproductdata . '';
}
}
}
...
{ 
	...
	/*	 $list = array();
		...
		*/
		 ...
		 $list = array();
			$csv_headers = array("Order Number", "Item UPC Code","Item Bundle Code","Item Name", "Size" , "UOM" , "Vendor ID", "Ordered Qty", "List Price", "Delivery Date", "Delivery Time " ,"Is Flexible Shipping", "Is Unattended Shipping", "Customer Group Name","Purchase Customer Name", "Delivery Customer Name",  'Customer Contact Number', 'Customer Billing Street Address', 'Customer Billing City','Customer Billing  State', 'Customer Billing Zipcode','Customer Delivery Address','Delivery City ','Delivery State','Delivery Zipcode', 'Accept Substitute');
...
foreach($selections as $selection){ 
     ...
     $selection= $selection->getSku().'.';
$list['Item Bundle Code'] =$selection->getSku().'.';
 $selection.= $selection->getSku().'.';
   array_push($list['Item Bundle Code'] , $selection);
}
...
foreach($selections as $selection){ 
 ...
 //  array_push($list['Item Bundle Code'] , $selection);
   ...
   // $finalval = $finalval . $test['value'] . ',';
	...
	$list['Item Bundle Code'] =$selection . $selection->getSku().',';
		...
		if($report_date == "order_date"){
				...
				/*	$csv_headers = array("Order Number", "Item UPC Code", "Item Name", "Size", "UOM", "Vendor ID", "Ordered Qty","List Price","Extended Price","discounted Price","Delivery fees", "Delivery Date", "Delivery Time", "Is Flexible Shipping", "Is Unattended Shipping", "Discount Code","Cusotmer Group", "Purchase Customer Name", "Delivery Customer Name", "Customer Contact Number", "Customer Billing Street Address", "Customer Billing City & State", "Customer Billing Zipcode", "Customer Delivery Address","Delivery City & State","Delivery Zipcode", "Accept Substitute");
					...
					*/
					...
					$csv_headers = array("Order Number", "Item UPC Code","Item Bundle Code", "Item Name", "Size", "UOM", "Vendor ID", "Ordered Qty","List Price","Extended Price","discounted Price","Delivery fees", "Delivery Date", "Delivery Time", "Is Flexible Shipping", "Is Unattended Shipping", "Discount Code","Cusotmer Group", "Purchase Customer Name", "Delivery Customer Name", "Customer Contact Number", "Customer Billing Street Address", "Customer Billing City & State", "Customer Billing Zipcode", "Customer Delivery Address","Delivery City & State","Delivery Zipcode", "Accept Substitute");
...
$finalval = $finalval .' '.iconv("UTF-8","ASCII//TRANSLIT",$selection->getSku()) .' , ';
  //$list['Item Bundle Code'] = ' '.iconv("UTF-8","ASCII//TRANSLIT",$selection->getSku()) .' , ';
  //  echo $list['Item Bundle Code'];
}

$list['Item Bundle Code'] = $finalval;
//echo $list['Item Bundle Code'];
//exit;	
