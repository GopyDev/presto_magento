...
class Mirasvit_Fpc_Helper_Help extends Mirasvit_MstCore_Helper_Help
{
    protected $_help = array(
        'system' => array(
            ...
            'extended_settings_clean_old_cache' => 'Clear old cache by cron. If use that runs Magento cron job has not enough permissions for this operation, it will flush all cache. If you see such situation, you need to run Magento cron job from user with more permissions or set \'No\' in this configuration.',
