...
class Cybernetikz_Salesreport_Adminhtml_SalesController extends Mage_Adminhtml_Controller_Action
{
	...
	public function reportimanageAction()
    {
        $this->loadLayout()->renderLayout();
    }
	
	public function newreport888Action()
    {
        $this->loadLayout()->renderLayout();
    }
	
	public function reportimanagerAction()
    {
        $this->loadLayout()->renderLayout();
    }
	...
	public function newreport2Action()
    {
        $this->loadLayout()->renderLayout();
    }
	
	public function proreportAction()
    {
        $this->loadLayout()->renderLayout();
    }
	
	public function ordrshreportAction()
    {
        $this->loadLayout()->renderLayout();
    }
	
	public function ordrshreport5Action()
    {
        $this->loadLayout()->renderLayout();
    }
	
	public function scatAction()
    {
        $this->loadLayout()->renderLayout();
    }
	
	public function dashreportAction()
    {
        $this->loadLayout()->renderLayout();
    }
