...
if(isset($_GET["sh"]) && $_GET["sh"]!="")
{
    ...
    <td>
	<a href="<?php echo Mage::getBaseUrl(); ?>?gt=nf2&it=all&t=<?php echo $_GET["t"]; ?>" style="text-decoration:underline;<?php if(!isset($_GET["it"]) || $_GET["it"]=='all' || $_GET["it"]=='' ) { echo 'text-decoration:none;color:red'; } ?>"  > All Items </a> <br/> <a href="<?php echo Mage::getBaseUrl(); ?>?gt=nf2&it=a&t=<?php echo $_GET["t"]; ?>" style="text-decoration:underline;<?php if(isset($_GET["it"]) && $_GET["it"]=='a') { echo 'text-decoration:none;color:red;'; } ?>"> Incomplete  </a> <br/> <a href="<?php echo Mage::getBaseUrl(); ?>?gt=nf2&it=b&t=<?php echo $_GET["t"]; ?>" style="text-decoration:underline;<?php if(isset($_GET["it"]) && $_GET["it"]=='b') { echo 'text-decoration:none;color:red;'; } ?>"> Not Packed  </a>
    <div>&nbsp;</div>
    </td>
    </tr>
    </table>
    ...
    <tr>
    <td>
    <a style="text-decoration:underline;<?php if(!isset($_GET["v"]) || $_GET["v"]=='all' || $_GET["v"]=='' ) { echo 'text-decoration:none;color:red'; } ?>" href="<?php echo Mage::getBaseUrl(); ?>?gt=nf2&it=<?php echo $_GET["it"]; ?>&t=<?php echo $_GET["t"]; ?>" > All  </a>
    <br/>
	<a style="text-decoration:underline;<?php if(isset($_GET["v"]) && $_GET["v"]=='b') { echo 'text-decoration:none;color:red;'; } ?>" href="<?php echo Mage::getBaseUrl(); ?>?gt=nf2&it=<?php echo $_GET["it"]; ?>&v=b&t=<?php echo $_GET["t"]; ?>" > Box Truck  </a> <br/>
    <a style="text-decoration:underline;<?php if(isset($_GET["v"]) && $_GET["v"]=='v') { echo 'text-decoration:none;color:red;'; } ?>" href="<?php echo Mage::getBaseUrl(); ?>?gt=nf2&it=<?php echo $_GET["it"]; ?>&v=v&t=<?php echo $_GET["t"]; ?>" > Van 1  </a>
    <div>&nbsp;</div>
    </td>
    </tr>
    </table>
    ...
    <tr>
    <td>
    <a style="text-decoration:underline;<?php if(!isset($_GET["t"]) || $_GET["t"]=='all' || $_GET["t"]=='' ) { echo 'text-decoration:none;color:red'; } ?>" href="<?php echo Mage::getBaseUrl(); ?>?gt=nf2&it=<?php echo $_GET["it"]; ?>&v=<?php echo $_GET["v"]; ?>" > All  </a>
    <br/>
	<a style="text-decoration:underline;<?php if(isset($_GET["t"]) && $_GET["t"]=='d') { echo 'text-decoration:none;color:red;'; } ?>" href="<?php echo Mage::getBaseUrl(); ?>?gt=nf2&it=<?php echo $_GET["it"]; ?>&v=<?php echo $_GET["v"]; ?>&t=d" > Dry  </a> <br/>
    <a style="text-decoration:underline;<?php if(isset($_GET["t"]) && $_GET["t"]=='c') { echo 'text-decoration:none;color:red;'; } ?>" href="<?php echo Mage::getBaseUrl(); ?>?gt=nf2&it=<?php echo $_GET["it"]; ?>&v=<?php echo $_GET["v"]; ?>&t=c" > Cold
      </a>
       <br/>
      <a style="text-decoration:underline;<?php if(isset($_GET["t"]) && $_GET["t"]=='f') { echo 'text-decoration:none;color:red;'; } ?>" href="<?php echo Mage::getBaseUrl(); ?>?gt=nf2&it=<?php echo $_GET["it"]; ?>&v=<?php echo $_GET["v"]; ?>&t=f" > Frozen
      </a>
    </td>
    </tr>
    </table>
	...
	<?php
       ...
       <a href="<?php echo $product222->getProductUrl(); ?>" target="_blank" ><img src="<?php echo $this->helper('catalog/image')->init($product222, 'small_image')->resize(50) ?>" border="0" width="50" alt="<?php echo $this->htmlEscape($product222->getName()) ?>" /> </a>
        ...
        <div style="display:inline-block; width:75%; verticle-align:middle;">  <?php echo $rows274pro; ?><br/><a href="<?php echo Mage::getBaseUrl(); ?>?item_id=<?php echo $value3e["item_id"]; ?>&rpc=<?php echo $_GET["ode"]; ?>" style="text-decoration:underline;color:red;font-size:12px;" target="_blank"> Product Change </a> &nbsp;<a href='javascript:void(0);' style="text-decoration:underline;color:green;font-size:12px;" onClick='backdrppick();' > ( Go Top ) </a>  </div>
		  ...
		  <span style="font-weight:bold;font-size:12px;color:black;">Picker : <?php echo $picker_name; ?></span>
		 ...
		 <div style="width:48%; float:right;">
           ...
           <?php if($value3e["note"]!="" && $value3e["note"]!="undefined") { ?>
		 <div style="width:95%;padding:5px;background:red;color:#fff;font-size:12px;font-weight:bold; margin-top:5px;">Picker Note :-
		 ...
		 <?php } else { ?>
		 <div style="width:95%;padding:5px;background:none;color:#000;font-size:12px;font-weight:bold;">Picker Note :-
		 <textarea id="nf-<?php echo $value3e['item_id']; ?>" name="nf-<?php echo $value3e['item_id']; ?>" style="border:1px solid #000;width:99%;" onBlur="donfnote('<?php echo $value3e["item_id"]; ?>');" ><?php echo $value3e["note"]; ?></textarea></div>
		 <div id="divnfres-<?php echo $value3e['item_id']; ?>"></div>
		 <?php } ?>
		  ...
		  <input type="button" style="background-color:red;padding:5px;color:#fff;" name="std" value="Substitute Needed" onClick="dosname2('<?php echo $value3e["idstring"]; ?>');" />
           ...
           <div id="sso-<?php echo $value3e["idstring"]; ?>" style="display:none;">

           <div style="font-weight:bold;padding:5px;font-size:12px;"> Substitute Info </div>
		  <textarea style="border:1px solid #000;height:auto;width:250px;margin-left:5px;" name="snote-<?php echo $value3e["idstring"]; ?>" id="snote-<?php echo $value3e["idstring"]; ?>" ><?php echo $rows274; ?></textarea>
		...
		<?php } ?>
		 ...
		 ?>
		   ...
		   <div id="nfdiv-<?php echo $temp[1]; ?>" style="float:left; margin-left:10px; margin-top:5px;  width:106px; <?php if($rows22b!='1' && $_GET["it"]!='b') { ?> display:none; <?php } ?>"  >
				...
				<?php
					  if($rows22b!='1')
					   ...
					   <?php } else {
					    echo '<div style="background-color:green;font-weight:bold;color:#fff;padding:5px;width:106px;" > Already Packed </div>';
					    } ?>
					   </div>
          ...
          <span style="font-weight:bold;font-size:12px;color:black;"><?php echo $value3e["cust"]; ?></span>
          <?php
		  ...
		  {
		  ?>
		  <span style="font-size:12px;font-weight:bold;color:green;"><br/><b> <?php echo $vname; ?></b> # <?php echo $rc; ?></span>
		  <?php
		  }
		  ?>
