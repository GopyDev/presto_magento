<?php
      if(isset($_GET["gt"]) && $_GET["gt"]=='cpick2' ) {
	...
	Cold Pick List :-
	 ...
	 ?>
	     <a href="<?php echo Mage::getBaseUrl(); ?>?gt=cpick2&picker2=<?php echo $order_picker["picker_id"]; ?>"><?php echo $picker_name; ?></a>&nbsp;&nbsp;
	 ...
	 <?php }
	  if(isset($_GET["picker2"]) && $_GET["picker2"]!="" && $_GET["gt"]=='cpick2' ) {
...
?>
   ...
   <div id="tblcoldpick" style="padding-top:10px;">
	...
	<table border=1 cellpadding="5" id="" cellspacing="5" style="border-collapse:collapse;page-break-before:always;font-size:11px;" >
