...
function myf1()
{
	 ...
	 jQuery('.block-title').empty();
	 // jQuery('.opc-block-progress').html('<div class="block-title"><strong><span>Your Checkout Progress</span></strong></div>');
	 jQuery('#billing-progress-opcheckout').empty();
	 jQuery('#shipping-progress-opcheckout').empty();
	 jQuery('#shipping_method-progress-opcheckout').empty();
	 jQuery('#payment-progress-opcheckout').empty();
	
	// document.getElementById('billing-progress-opcheckout').style.display = "none"; 
	//document.getElementById('billing-progress-opcheckout').style.display = "none"; 
}
